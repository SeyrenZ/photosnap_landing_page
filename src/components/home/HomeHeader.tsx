    ...
    <div className="w-full md:h-[650px] h-auto ">
      <div className="w-full h-full max-w-[1440px] mx-auto flex md:flex-row flex-col items-center">
        <div className="w-full lg:max-w-[610px] md:min-w-[495px] h-full md:p-0 px-[33px] py-20 flex items-center justify-center bg-black relative">
          <div className="absolute w-1.5 h-[304px] bg-white left-0 bg-gradient-to-t from-[#FFC593] via-[#BC7198] to-[#5A77FF] sm:block hidden" />
          <div className="absolute w-32 h-1.5 bg-white top-0 left-11 bg-gradient-to-r from-[#FFC593] via-[#BC7198] to-[#5A77FF] block sm:hidden" />
          <div
